...
within PRJ_test.ResidentialApartmentBlock_3.ResidentialApartmentBlock_3_Models;
model ResidentialApartmentBlock_3_SingleDwelling
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_3/ResidentialApartmentBlock_3_Models/InternalGains_ResidentialApartmentBlock_3SingleDwelling.txt"),
      columns={2,3,4})
...
equation
  ...
  events=false));
end ResidentialApartmentBlock_3_SingleDwelling;
