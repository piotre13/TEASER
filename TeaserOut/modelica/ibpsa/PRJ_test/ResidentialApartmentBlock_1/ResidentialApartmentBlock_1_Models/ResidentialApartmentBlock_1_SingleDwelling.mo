...
within PRJ_test.ResidentialApartmentBlock_1.ResidentialApartmentBlock_1_Models;
model ResidentialApartmentBlock_1_SingleDwelling
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_1/ResidentialApartmentBlock_1_Models/InternalGains_ResidentialApartmentBlock_1SingleDwelling.txt"),
      columns={2,3,4})
