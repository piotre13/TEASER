...
within PRJ_test.ResidentialApartmentBlock_4.ResidentialApartmentBlock_4_Models;
model ResidentialApartmentBlock_4_SingleDwelling
  "This is the simulation model of SingleDwelling within building ResidentialApartmentBlock_4 with traceable ID None"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_4/ResidentialApartmentBlock_4_Models/InternalGains_ResidentialApartmentBlock_4SingleDwelling.txt"),
      columns={2,3,4})
