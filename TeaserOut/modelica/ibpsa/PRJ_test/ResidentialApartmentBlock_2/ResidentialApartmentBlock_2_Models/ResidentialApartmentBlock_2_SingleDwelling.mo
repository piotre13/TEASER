...
within PRJ_test.ResidentialApartmentBlock_2.ResidentialApartmentBlock_2_Models;
model ResidentialApartmentBlock_2_SingleDwelling
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_2/ResidentialApartmentBlock_2_Models/InternalGains_ResidentialApartmentBlock_2SingleDwelling.txt"),
      columns={2,3,4})
