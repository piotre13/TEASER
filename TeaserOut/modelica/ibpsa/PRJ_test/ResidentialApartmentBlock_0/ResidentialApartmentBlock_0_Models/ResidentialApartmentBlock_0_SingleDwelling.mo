...
within PRJ_test.ResidentialApartmentBlock_0.ResidentialApartmentBlock_0_Models;
model ResidentialApartmentBlock_0_SingleDwelling
  "This is the simulation model of SingleDwelling within building ResidentialApartmentBlock_0 with traceable ID None"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_0/ResidentialApartmentBlock_0_Models/InternalGains_ResidentialApartmentBlock_0SingleDwelling.txt"),
      columns={2,3,4})
...
equation
  ...
  events=false));
end ResidentialApartmentBlock_0_SingleDwelling;
