...
within PRJ_test.ResidentialApartmentBlock_4;
model ResidentialApartmentBlock_4
  "This is the simulation model of ResidentialApartmentBlock_4 with traceable ID 4"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      ResidentialApartmentBlock_4_DataBase.ResidentialApartmentBlock_4_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_4/InternalGains_ResidentialApartmentBlock_4.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_4/AHU_ResidentialApartmentBlock_4.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_4/TsetHeat_ResidentialApartmentBlock_4.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_4/TsetCool_ResidentialApartmentBlock_4.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialApartmentBlock_4/ResidentialApartmentBlock_4.mos"
      "Simulate and Plot"),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end ResidentialApartmentBlock_4;
