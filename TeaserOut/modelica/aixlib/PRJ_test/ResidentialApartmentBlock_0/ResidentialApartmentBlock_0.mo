...
within PRJ_test.ResidentialApartmentBlock_0;
model ResidentialApartmentBlock_0
  "This is the simulation model of ResidentialApartmentBlock_0 with traceable ID 0"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      ResidentialApartmentBlock_0_DataBase.ResidentialApartmentBlock_0_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_0/InternalGains_ResidentialApartmentBlock_0.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_0/AHU_ResidentialApartmentBlock_0.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_0/TsetHeat_ResidentialApartmentBlock_0.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_0/TsetCool_ResidentialApartmentBlock_0.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialApartmentBlock_0/ResidentialApartmentBlock_0.mos"
      "Simulate and Plot"),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end ResidentialApartmentBlock_0;
