...
within PRJ_test.ResidentialApartmentBlock_3;
model ResidentialApartmentBlock_3
  "This is the simulation model of ResidentialApartmentBlock_3 with traceable ID 3"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      ResidentialApartmentBlock_3_DataBase.ResidentialApartmentBlock_3_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_3/InternalGains_ResidentialApartmentBlock_3.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_3/AHU_ResidentialApartmentBlock_3.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_3/TsetHeat_ResidentialApartmentBlock_3.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_3/TsetCool_ResidentialApartmentBlock_3.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialApartmentBlock_3/ResidentialApartmentBlock_3.mos"
      "Simulate and Plot"),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end ResidentialApartmentBlock_3;
