...
within PRJ_test.ResidentialApartmentBlock_2;
model ResidentialApartmentBlock_2
  "This is the simulation model of ResidentialApartmentBlock_2 with traceable ID 2"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      ResidentialApartmentBlock_2_DataBase.ResidentialApartmentBlock_2_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_2/InternalGains_ResidentialApartmentBlock_2.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_2/AHU_ResidentialApartmentBlock_2.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://PRJ_test/ResidentialApartmentBlock_2/TsetHeat_ResidentialApartmentBlock_2.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://PRJ_test/ResidentialApartmentBlock_2/TsetCool_ResidentialApartmentBlock_2.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialApartmentBlock_2/ResidentialApartmentBlock_2.mos"
      "Simulate and Plot"),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end ResidentialApartmentBlock_2;
