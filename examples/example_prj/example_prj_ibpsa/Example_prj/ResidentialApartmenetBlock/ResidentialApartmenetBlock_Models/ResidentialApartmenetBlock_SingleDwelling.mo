...
within Example_prj.ResidentialApartmenetBlock.ResidentialApartmenetBlock_Models;
model ResidentialApartmenetBlock_SingleDwelling
  "This is the simulation model of SingleDwelling within building ResidentialApartmenetBlock with traceable ID None"

  AixLib.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    calTSky=AixLib.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation,
    computeWetBulbTemperature=false,
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://Example_prj/DEU_BW_Mannheim_107290_TRY2010_12_Jahr_BBSR.mos"))
    "Weather data reader"
  ...
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.001169286735091)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.02,
    nExt=1,
    RExt={0.00018047343307290003},
    CExt={57602634.09588952},
    ...
    RExtRem=0.0038074010464627635,
    AFloor=45.514,
    hConFloor=1.7,
    nFloor=1,
    RFloor={0.002573573616107992},
    RFloorRem=0.019224212882224388,
    CFloor={5469110.831910998},
    ARoof=45.514,
    hConRoof=1.7,
    nRoof=1,
    RRoof={0.0009499757664815879},
    RRoofRem=0.0334298848688949,
    CRoof={19000189.19581412},
    ...
    nOrientations=4,
    AWin={11.484200000000001, 11.484200000000001, 11.484200000000001, 11.484200000000001},
    ATransparent={11.484200000000001, 11.484200000000001, 11.484200000000001, 11.484200000000001},
    AExt={44.8826, 44.8826, 44.8826, 44.8826})
    "Thermal zone"
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*179.5304)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Example_prj/ResidentialApartmenetBlock/ResidentialApartmenetBlock_Models/InternalGains_ResidentialApartmenetBlockSingleDwelling.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1137.8500000000001)
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[1](    til={0.0},
    each lat = 0.88645272708792,
    azi={0.0})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  AixLib.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[1](    til={0.0},
    each lat = 0.88645272708792,
    azi={0.0})
...
equation
  ...
  events=false));
end ResidentialApartmenetBlock_SingleDwelling;
