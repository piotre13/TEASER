...
model ResidentialApartmenetBlock
  "This is the simulation model of ResidentialApartmenetBlock with traceable ID 4"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      ResidentialApartmenetBlock_DataBase.ResidentialApartmenetBlock_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Example_prj/ResidentialApartmenetBlock/InternalGains_ResidentialApartmenetBlock.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Example_prj/ResidentialApartmenetBlock/AHU_ResidentialApartmenetBlock.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Example_prj/ResidentialApartmenetBlock/TsetHeat_ResidentialApartmenetBlock.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://Example_prj/ResidentialApartmenetBlock/TsetCool_ResidentialApartmenetBlock.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialApartmenetBlock/ResidentialApartmenetBlock.mos"
      "Simulate and Plot"),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textString="TB")}));
end ResidentialApartmenetBlock;
